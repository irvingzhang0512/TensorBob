...
from tensorbob.dataset.camvid import get_camvid_segmentation_dataset, get_camvid_segmentation_merged_dataset
...
class CamVidTest(unittest.TestCase):
    ...
    def test_segmentation_merged_dataset(self):
        ...
        dataset = get_camvid_segmentation_merged_dataset(
